...
export default function TechStack() {
  return (
    <section className="max-w-screen-md w-full gap-8 flex flex-col justify-center items-center">
      <motion.h2
      ...
      >
        <center>Powered by the latest technology stack and APIs</center>
      </motion.h2>
      <div className="w-full grid grid-cols-6 gap-3 place-items-center mx-5">
        <Tooltip content="NextJs">
          <motion.svg
            ...
            viewBox="0 0 24 24"
            fill="CurrentColor"
            className="h-12 w-12 text-foreground/80 sm:mx-12 "
          >
        ...
        <Tooltip content="TailwindCSS">
          <motion.svg
            ...
            xmlns="http://www.w3.org/2000/svg"
            fill="CurrentColor"
            className="h-12 w-12 text-foreground/8 sm:mx-12 "
          >
        ...
        <Tooltip content="Framer Motion">
          <motion.svg
            ...
            xmlns="http://www.w3.org/2000/svg"
            fill="CurrentColor"
            className="h-12 w-12 text-foreground/80 sm:mx-4"
          >
